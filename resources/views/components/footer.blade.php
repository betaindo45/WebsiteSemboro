<footer class="bg-secondary pt-12 pb-12">
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full px-4 mb-6 text-slate-600 font-medium md:w-1/3 text-lg">
                <h2 class="font-bold text-4xl mb-5 text-white">Balai Desa Semboro</h2>
                <h3>pemdessemboro@gmail.com</h3>
                <p>Jl. Melati No. 1</p>
